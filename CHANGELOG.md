...
All notable changes to **dota2-scraper** are documented in this file.
...
### Changed
- README rewritten for clear Dota 2 / source identification (Dotabuff, Liquipedia, OpenDota, DLTV)
